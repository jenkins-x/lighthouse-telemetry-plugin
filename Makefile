...
SHELL := /bin/bash
NAME := jx-project
BINARY_NAME := lighthouse-telemetry-plugin
BUILD_TARGET = build
...
BUILDFLAGS :=  -ldflags \
  " -X $(ROOT_PACKAGE)/pkg/version.Version=$(VERSION)\
		...
		-X github.com/jenkins-x/lighthouse-telemetry-plugin/internal/version.Version=$(VERSION)\
		-X github.com/jenkins-x/lighthouse-telemetry-plugin/internal/version.Revision='$(REV)'\
		-X github.com/jenkins-x/lighthouse-telemetry-plugin/internal/version.Date='$(BUILD_DATE)'\
		$(BUILD_TIME_CONFIG_FLAGS)"
