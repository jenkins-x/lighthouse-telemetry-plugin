...
export JENKINS_X_URL='https://dashboard-jx.dev.jenkins-x.me/jenkins-x/lighthouse-telemetry-plugin/HEAD/1'
...
export MINK_IMAGE='ghcr.io/jenkins-x/lighthouse-telemetry-plugin:0.0.5'
