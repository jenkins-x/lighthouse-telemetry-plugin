...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x/lighthouse-telemetry-plugin/main/1'
...
export MINK_IMAGE='ghcr.io/jenkins-x/lighthouse-telemetry-plugin:0.1.2'
