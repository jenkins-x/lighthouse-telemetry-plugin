...
export JENKINS_X_URL='https://dashboard-jx.dev.jenkins-x.me/jenkins-x/lighthouse-telemetry-plugin/main/2'
export JX_CHART_REPOSITORY='http://jenkins-x-chartmuseum.jx.svc.cluster.local:8080'
export MINK_AS='tekton-bot'
export MINK_IMAGE='gcr.io/jenkinsxio/lighthouse-telemetry-plugin:0.0.2'
