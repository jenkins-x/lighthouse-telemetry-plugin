...
export APP_NAME='lighthouse-telemetry-plugin'
...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x/lighthouse-telemetry-plugin/main/7'
...
export MINK_IMAGE='ghcr.io/jenkins-x/lighthouse-telemetry-plugin:0.1.4'
export NAMESPACE_SUB_DOMAIN='-jx.'
export PIPELINE_KIND='release'
export PUSH_CONTAINER_REGISTRY='ghcr.io'
export REPO_NAME='lighthouse-telemetry-plugin'
